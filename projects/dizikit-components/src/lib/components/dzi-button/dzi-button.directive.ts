...
export class DziButtonDirective {
    ...
    @HostBinding('class.dzi-button') readonly baseClass = true;

    @HostBinding('class')
    get variantClass() {
        return `dzi-button--${this.variant}`;
    }

    @HostBinding('class.dzi-button--sm')
    get isSmall() {
        return this.size === 'sm';
    }

    @HostBinding('class.dzi-button--md')
    get isMedium() {
        return this.size === 'md';
    }

    @HostBinding('class.dzi-button--lg')
    get isLarge() {
        return this.size === 'lg';
    }

...
@Component({
    selector: 'dzi-checkbox',
    standalone: true,
    imports: [],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    templateUrl: './dzi-checkbox.html',
    styleUrls: ['./dzi-checkbox.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => DziCheckboxComponent),
            multi: true,
        },
    ],
})
export class DziCheckboxComponent implements ControlValueAccessor {
    @ViewChild('inputEl', { static: true }) inputEl!: ElementRef<HTMLInputElement>;

    /** Unique ID for this checkbox instance */
    readonly inputId = `dzi-checkbox-${nextCheckboxId++}`;
